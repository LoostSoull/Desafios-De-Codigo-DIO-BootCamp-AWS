...
public class Servidor {
    public static void main(String[] args) {
        ...
        int numeroMinimoNodes = (int) Math.ceil((double)numeroTotalPods/(double)podsPorNode);


        //TODO: Calcule o número mínimo de servidores necessários
        int numeroMinimoServidores = (int) Math.ceil((double)numeroTotalPods/(double)podsPorServidor);
