...
public class Calculo {
    public static void main(String[] args) {
        ...
        //TODO: Calcule os custos
            ...
            double bancoResul = custoPorHoraBancoDados * quantidadeBancosDados;
            double serverResul = custoPorHoraServidor * quantidadeServidores;
            double custoTotal = bancoResul + serverResul;
